...
Includes the JS logical && operator. It can be handy for conditionally including an element:
...
Can be used for larger expressions
...
In cases you might want a component to hide itself even though it was rendered by another component. To do this return null instead of its render output
